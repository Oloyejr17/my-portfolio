...
>
  Hi there,
        ...
        <motion.p
          className="text-lg md:text-2xl text-gray-300 max-w-md mx-auto md:mx-0 leading-relaxed"
          style={{ y }}
        >
          ...
          modern JavaScript technologies. My focus is on delivering high-performance, 
          visually engaging, and user-centric digital experiences.
        </motion.p>

        <motion.p
          className="text-gray-400 max-w-md md:max-w-lg mx-auto md:mx-0 leading-relaxed text-base md:text-lg"
          style={{ y }}
        >
          With a strong background in both design and development, I bridge the gap 
          between beautiful interfaces and robust functionality, helping clients bring 
          their ideas to life efficiently and elegantly.
        </motion.p>
      </div>
